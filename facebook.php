...
Description: This plugin helps you create a simple widgets, shortcode and gutenberg block for facebook like box in WordPress.
Version: 3.1.0
Author: Prem Tiwari
...
/**
 * Adds a custom block to the WordPress site.
 */
function custom_gutenberg_facebook_like_box() {
    wp_register_script(
        'gutenberg-facebook-like-box',
        plugin_dir_url( __FILE__ ) . 'gutenberg-facebook-like-box.transpiled.js',
        array('wp-blocks', 'wp-element', 'wp-editor', 'wp-components', 'wp-i18n')
    );

    register_block_type('custom/facebook-like-box', array(
        'editor_script' => 'gutenberg-facebook-like-box',
    ));
}
add_action('init', 'custom_gutenberg_facebook_like_box');
